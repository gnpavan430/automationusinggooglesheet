...
/*    @Rule
    ...
    public static IOSDriver initializeDriver() throws MalformedURLException {
        ...
        if(driver!=null){
            ...
            driver1.executeScript("client:client.launch(\"com.klm.mobile.iphone.MCAR-iPhone\", \"false\", \"true\")");
            driver1.manage().timeouts().implicitlyWait(4000, TimeUnit.MILLISECONDS);
